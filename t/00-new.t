...
warning_is { Device::Firewall::PaloAlto->new(uri => 'scheme://localhost', username => 'admin', password => 'password') } "Incorrect URI scheme: must be either http or https", "Warn on scheme";
